...
#print(출력) ,input(입력)
'''
my_str = input("입력해보세요 :")#입력 받기전 내용 출력
#print()함수의 기능 포함
print(my_str)
'''
#(5) 입력된 값을 숫자로
...
#split() 복습: 기준이 되는 문자로 대상 문자열을 나눠서 '리스트'로
...
min = int(input("주차 시간을 분 다위로 입력(최소60분) :"))
price = 1000+((min - 60)*100)
