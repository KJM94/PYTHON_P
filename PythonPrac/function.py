...
'''
#함수를 define(정의)하기만 하면 프로그램 수행에 영향 X
...
#print()함수 호출 시 값을 몇 개 전달하더라도 다 출력
...
'''
재귀 함수
    -함수의 수행문 안에서 나 자긴 자신 함수를 다시 호출하는 함수
    ...
    -함수 호출 시 'stack'이라는 메모리 구조를 사용
        ...
        Stack : First in Last Out(FILO)
            ...
            >StackOverFlow 오류 발생
    재귀 함수도 반복문 처럼 반복 호출이 끝날 수 있는 조건이 필요
        >빠져나갈 구멍이 필요하다.
