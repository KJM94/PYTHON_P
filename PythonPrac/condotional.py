...
[비교연산자]
    ...
    a == b a가 b랑 같냐
    a != b a가 b랑 같지 않냐
        -컴퓨터한테 결과를 물어보는 것! 맞으면 맞다고 가르쳐 주는 값은 True
        -등호(=) 다른 연산자와 함께 사용할때는  다른 연산자보다 항상 뒤에 위치
            >복합대입연산자도 동일 a += 1

    [논리연산자]
        a or b : a 또는 b 둘 중 하나라도 참이면 참/둘 다 거짓이어야 거짓
        a and b: a 그리고 b 둘 다 참이면 참 /둘 중 하나도 거짓이면 거짓
...
'''
'''
num1,num2 = map(int,input("2개의 숫자를 입력 :").split())
op = input("연산할 기호 입력(+,-,*,/) : ")
...
print("최종 결재액은 {}원 입니다.".format(price - sale))

if price <= 10000 :
    print("10000원 이상 구매 시 할인되요~")
