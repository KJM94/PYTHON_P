...
#리스트 : 각 요소의 형태에 따라 인덱싱 결과(자료형)이 다르다.

#이중 리스트 인덱싱(리스트 안에 리스트를 가진 경우)
my_list=["한수창","홍길동",["임꺽정","이몽룡"]]
print(my_list[2])#리스트
print(my_list[2][0])#my_list 3번째 요소 리스트에서 1번째 요소 인덱싱
...
#count(value) : 리스트에 존재하는 value 갯수 변환
a=[1,2,3,1,2,3,1,2,3]
print(a.count(2))
print(a.count(5))#없으면 0
...
print(a_)
print(a)
print(a.pop())#index를 사용하지 않으면 기본 '맨 뒤'
...
a[3]=-10
c[0]=-20
#c=a를 했을 때 이미 만들어진 a리스트를 c가 같이 가리킨다
...
a.append(2019)
print(a[0],a[5][0]+a[2]+a[3][1],a[3][0]+a[4],a[6],a[5][0]+a[1])
'''
    my_list를 이용하여 "안녕하세요!" 문자열 만들고 출력하기
    join()함수 활용
'''
my_list=["!","요","세","요","하","녕","안"]
my_list.reverse()
